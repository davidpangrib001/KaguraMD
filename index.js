...
console.log(chalk.black(chalk.bgWhite('「 RECEIVED 」')), chalk.black(chalk.bgGreen(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> From'), chalk.green(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> In'), chalk.green(m.isGroup ? pushname : 'Private Chat', m.chat))
}
...
console.log('Sukses Mereset Limit!')
}, {
scheduled: true,
...
await kagura.setStatus(`Runtime : ${runtime(uptime)}`)
...
case 'bisakah':
if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
const bisa = ['Bisa','Gak Bisa','Gak Bisa Ajg Aaokawok','TENTU PASTI KAMU BISA!!!!','Ngak Bisa...','Ya Mana Bisa Ajg, Lu Kan Masih alim.. 🤣']
...
case 'menu': {
if(typemenu == 'allmenu'){
await kagura.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam, ownername, time, tanggal), `🇴​​​​​🇳​​​​​🇪​​​​​ 🇧​​​​​🇴​​​​​🇹​​​​​🇿`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Github`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}}] )
}
if(typemenu == 'simple'){
await kagura.send5ButImg(from, `` + '' + lang.menusimpel(botname, pushname, salam, ownername, time, tanggal), `🇴​​​​​🇳​​​​​🇪​​​​​ 🇧​​​​​🇴​​​​​🇹​​​​​🇿`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Github`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}}] )
}
}
break
case 'menu1':
